...
This project is essentially a fork of what my professor did in class, we just had to add the functionality of editing and deleting
for this assignment as well as deployment to heroku.
...
__Production__. 
When your read to deploy to Netlify you first must build a deployment build of the client site. To do this run ```npm run build```. This will create a new folder called www inside the employee manager folder. This folder contains the optimized production bundle. This uses command uses snowpack. Once you have this folder created commit your changes to git and visit your Heroku app an test your project. 
